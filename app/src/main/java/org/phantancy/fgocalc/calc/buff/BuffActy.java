...
public class BuffActy extends BaseActy implements BuffContract.View {
    ...
    Button abBtnFgowiki;
    @BindView(R.id.ab_ll_altria)
    LinearLayout abLlAltria;
    ...
    private void setListener() {
        ...
        abLlAltria.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                adapter.altriaBuffs(50,20,30);
            }
        });
